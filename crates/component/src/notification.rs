...
impl Render for Notification {
    fn render(&mut self, window: &mut Window, cx: &mut Context<Self>) -> impl IntoElement {
        ...
        // 토스트 그림자 잉크는 테마가 정한다 — 어두운 테마에서 shadcn 기본값(0.1)은 안 보인다.
        let shadow_ink = cx.theme().dialog_shadow_alpha;
        ...
        BaseToast::new("notification")
            ...
            // 톤이 비슷한 패널 위에서도 확실히 떠 보이도록 그림자 잉크를 테마에서 받는다.
            .shadow(toast_shadow(shadow_ink, 1.))
            .py_3p5()
            .px_4()
            .gap_3()
            ...
            .with_animation(
                ...
                move |this, delta| {
                    if closing {
                        ...
                        let that = this
                            .opacity(opacity)
                            .shadow(toast_shadow(shadow_ink, opacity.powi(3)));
