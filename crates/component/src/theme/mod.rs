...
/// Black alpha of popup/dialog shadows when the theme doesn't override it —
/// shadcn/ui's surface ink. A dark theme should raise it (e.g. 0.9), which is
/// what these fields exist for: at 0.1 the shadow vanishes on a dark surface.
const DEFAULT_SHADOW_ALPHA: f32 = crate::styled::SURFACE_SHADOW_INK;
...
impl From<&ThemeColor> for Theme {
    fn from(colors: &ThemeColor) -> Self {
        Theme {
            ...
            radius_lg: px(8.),
            shadow: true,
            popup_shadow_alpha: DEFAULT_SHADOW_ALPHA,
            dialog_shadow_alpha: DEFAULT_SHADOW_ALPHA,
            focus_ring: true,
